...
void asymptotics()
{
    ...
    // Exclusive amplitude
    pseudoscalar_exchange excZc (&kZc, &alpha, "Zc(3900)^{#minus}  production");
    ...
    // Exclusive amplitude
    pseudoscalar_exchange excZb (&kZb, &alpha, "Zb(10610)^{#minus}  production");
    ...
    // Exclusive amplitude
    pseudoscalar_exchange excZbp (&kZbp, &alpha, "Zb(10650)^{#minus}  production");
