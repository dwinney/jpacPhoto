...
namespace jpacPhoto
{
    namespace analytic
    {
        class pomeron_exchange : public one_meson::raw_amplitude
        {
            public: 

            pomeron_exchange(one_meson::amplitude_key key, one_meson::kinematics xkinem, std::string id = "pomeron_exchange")
