...
namespace jpacPhoto
{
    namespace regge
    {
        class natural_exchange : public one_meson::raw_amplitude
        {
            public: 

            natural_exchange(one_meson::amplitude_key key, one_meson::kinematics xkinem, std::string id = "natural_exchange")
            : one_meson::raw_amplitude(key, xkinem, id), _J(1), _m(M_RHO)
            {
                initialize(6);
            };
